    ...
    <div className="space-y-6">
      ...
      {resources.length > 0 ? (
        ...
        <div className="rounded-sm border border-dashed border-[#3d3830] bg-[#1c1a17] px-6 py-16 text-center">
          <h2 className="font-outfit text-xl font-bold text-[#e8e4db]">No tienes recursos adquiridos</h2>
          <p className="mt-2 text-[#8c8278]">Tus compras y licencias reales aparecerán aquí.</p>
        </div>
      )}
    </div>
  );
