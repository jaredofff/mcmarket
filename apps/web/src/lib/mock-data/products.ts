...
export const ADVANCED_ECONOMY_PRODUCT: Product = {
...
export const MYTHIC_MOBS_PRODUCT: Product = {
  id: 'mythic-mobs-1',
  name: 'MythicMobs Pro',
  slug: 'mythicmobs-pro',
  price: 29.99,
  ...
  downloads: 45231,
  image:
    'https://images.unsplash.com/photo-1614730321146-b6fa6a46bcb4?w=1200&h=675&fit=crop',
  compatible_versions: ['1.16', '1.17', '1.18', '1.19', '1.20', '1.21'],
  dependencies: ['Citizens', 'ProtocolLib'],
  current_version: '5.1.2',
  current_hash: 'b8g9c3d0f7e4a1b8c5d2e9f6a3b0c7d4e1f8a5b2c9d6e3f0a7b4c1d8e5f2a',
  last_updated: '2024-05-18',
  features: [
    '🐉 Advanced Boss & Mob Creation System',
    '⚔️ Complex Combat Mechanics & Skills',
    '🎨 Custom Model Data & Animations',
    '📍 Dynamic Spawning & Waypoints',
    '💀 Loot Tables & Rare Drop System',
    '🔗 Integration with 50+ Other Plugins',
    '🎯 Fully Customizable Abilities',
    '📊 Built-in Boss Difficulty Scaling',
  ],
  tags: ['Mobs', 'Bosses', 'Combat', 'Adventure'],
  description: `# MythicMobs Pro

Create the ultimate boss encounters and custom mobs with MythicMobs Pro. The most advanced mob creation plugin for Spigot/Paper.

## Features

- **Advanced Boss System**: Create complex boss encounters with multiple phases
- **Custom Abilities**: 100+ built-in abilities, fully customizable
- **Dynamic Loot**: Create rare drops with custom NBT data
- **Model Support**: Custom Model Data integration for resource packs
- **Network Ready**: Sync mobs across your server network

## Getting Started

Configuration is simple but powerful. Define your mobs in YAML:
...
MyFirstBoss:
  ...
  Damage: 8
  Skills:
    - skill:fireball @trigger ~onCombat 0.2
  Drops:
    - diamond_sword{CHANCE:0.05}
\`\`\`

## Premium Support

Enterprise customers get:
- Custom mob design consultations
- Priority bug fixes
  ...
  changelogs: [
    {
      ...
      changes: [
        {
          type: 'fixed',
          text: 'Fixed ability cooldown not resetting properly',
        },
        {
          type: 'improved',
          text: 'Better memory management for large boss encounters',
        },
      ],
    },
  ],
...
// Array de todos los productos mock
export const MOCK_PRODUCTS: Product[] = [
  ADVANCED_ECONOMY_PRODUCT,
  MYTHIC_MOBS_PRODUCT,
];

// Helper para obtener un producto por slug
export function getProductBySlug(slug: string): Product | undefined {
  return MOCK_PRODUCTS.find(p => p.slug === slug);
}

// Helper para obtener todos los slugs (para SSG)
