      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="border-t border-[#2d2a26] pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              href="#"
              className="w-8 h-8 flex items-center justify-center rounded-sm bg-[#1c1a17] border border-[#2d2a26] text-[#6b6459] hover:text-[#5865F2] hover:border-[#5865F2]/50 transition-all"
              aria-label="Discord"
            >
            ...
            <a
              href="#"
              className="w-8 h-8 flex items-center justify-center rounded-sm bg-[#1c1a17] border border-[#2d2a26] text-[#6b6459] hover:text-[#e8e4db] hover:border-[#a39c90]/50 transition-all"
              aria-label="GitHub"
            >
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
